...
import { DuplicateMapModal } from '../../components/DuplicateMapModal/DuplicateMapModal';
        ...
        {maps?.map((m) => (
          <li key={m.id} className={styles.card}>
            ...
            <div className={styles.actions}>
              ...
              <button onClick={() => setDuplicating({ id: m.id, name: m.name })}>Duplicate</button>
            </div>
          </li>
        ))}
      </ul>
